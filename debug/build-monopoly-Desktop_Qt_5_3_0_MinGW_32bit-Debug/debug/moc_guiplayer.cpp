...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GUIPlayer_t, stringdata) + ofs \
...
const QMetaObject GUIPlayer::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_GUIPlayer.data,
      qt_meta_data_GUIPlayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUIPlayer.stringdata))
